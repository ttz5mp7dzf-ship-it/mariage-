...
export default function InvitationOfficielle() {
  ...
  return (
    <section id="invitation" className="invitation-section py-32 px-4 relative flex justify-center items-start min-h-screen overflow-hidden bg-transparent scroll-mt-20">
      {/* Background motif */}
